...
function parseJsonResponse(text: string): Omit<InsightData, never> {
  try {
...
1. **ユーザー自身の深い理解**：その人がなぜその言説を信じているのかを心理学・社会学・政治学の知見から丁寧に解説し、その言説に対抗するための確かな事実とデータを提供する。

2. **大切な人への実践的な伝え方**：その知識を踏まえて、どのように噛み砕いて相手に伝えるか——具体的な言い回し、例え話、視点転換の問いかけ——を示す。
...
- **その言説が満たしている心理的ニーズ**：クルグランスキの「認知的閉鎖欲求」（不確実性が高い時期に単純で明快な答えを求める傾向）、スケープゴーティングのメカニズム、因果的単純化への欲求、コントロール感の回復欲求など。

- **社会学・心理学の具体的な研究・理論**：可能な限り以下を活用する。
  - ジョナサン・ハイトの道徳基盤理論（保守はケア・公平・忠誠・権威・純粋の5基盤、リベラルは主にケアと公平を重視）
  - アーリー・ホックシルドの「ディープストーリー」概念（「Strangers in Their Own Land」）——「自分たちはずっと列に並んでいたのに、割り込んでくる人がいる」という感覚的物語
  - フェスティンガーの認知的不協和——信念が揺らいだときの心理的防衛反応
  - カーネマンのシステム1（直感・感情）とシステム2（論理・熟考）——感情的な言説がなぜシステム1を直撃するか
  - 「バックファイア効果」——正論で反論されると信念が強化されるメカニズム（ニーハン・ライフラーの研究）
...
## SECTION 2：大切な人への実践的な伝え方

SECTION 1で得た理解と知見を踏まえて、実際の会話でどう伝えるかを示します。
言葉のトーンをSECTION 1より柔らかく、具体的に、生活感のある言葉で書いてください。
ここは「コーチング」です——ユーザーに「こう言ってみてください」と直接語りかけるように書く。

---

### 具体的な伝え方（conversation フィールド）

以下の要素を必ず含めてください：

**1. 基本姿勢（1〜2文）**
どんな心持ちで話すか。
例：「論破しようとすると『バックファイア効果』で信念が逆に強くなることが多い。まず相手の不安を受け止める姿勢から始める。」

**2. 具体的な言い回し・例え話（3〜5つ）**
実際に使える言葉をそのまま示す。

フォーマット例：
「『〇〇だよ』とすぐに言うより、こんな聞き方が届くかもしれません——『△△って感じることある？』。相手が自分の言葉で考え始めるきっかけになります。」

「たとえばこんな例え話が使えます：〔具体的な比喩〕」

**3. 視点転換のシナリオ（1〜2つ）**
相手が自分ごととして考えられるよう、身近な状況に置き換える例。
「もし自分の子どもが海外に移住して、現地で『外国人は追い出せ』と言われたら——そう想像してもらうだけで見え方が変わることがあります」
...
### 問いかけの例（question フィールド）

大切な人との会話で自然に差し込める問いを2〜3つ提示する。

条件：
- 結論を押しつけない
- 相手が内側から「ちょっと待てよ」と思えるような問い
- 答えを急かさない開かれた問い

「もし〜だったら」「この言説から一番得をしているのは誰だろう？」「〜という話を聞いたことある？」のような方向性で。
...
→ 「この重要な視点をまだ知らない人に、どう伝えるか」として書く。
  ...
  conversation：知らない人にどう説明するか。具体的な例え話と言い換え。
...
### ジェンダー・LGBTQ+
**理解**：「伝統的家族を守りたい」「急速な変化への戸惑い」は、文化的アイデンティティとの葛藤として現れる。道徳基盤理論でいう「純粋性・神聖さ」の基盤が強い人ほど、性的マイノリティを本能的に「異質なもの」として感じやすい。また、子どもへの影響を心配するのは「ケア」の道徳基盤からくる真剣な懸念であることを認識する。
...
### 歴史認識
**理解**：「自国を誇りたい」「国家アイデンティティと過去の批判が矛盾するように感じる」という実存的な葛藤。過去の国家行為への批判が自分自身への攻撃に感じられる「認知的融合」のメカニズム。歴史否定論は多くの場合、知識の欠如よりも心理的な防衛として機能している。
**事実**：日本政府自身が河野談話（1993年）・村山談話（1995年）・菅内閣談話（2010年）で植民地支配・侵略についての認識を公式に表明している事実。ドイツの戦後処理比較——徹底的な歴史清算が国際信頼と経済復興をもたらした歴史。歴史否定論の政治的利用に関する研究（ヤン・ウィレム・ダウエルの「敗北を抱きしめて」等）。
...
**事実**：社会的流動性の研究——日本を含むOECD諸国で「親の所得と子の所得の相関」が強まっており、スタートラインの不平等が深刻化している。ピケティ「21世紀の資本」（2013年）の実証——資本収益率が経済成長率を上回る構造的メカニズム。マルコム・グラッドウェル「アウトライアーズ」（2008年）——成功には個人の努力以外の要素（タイミング・環境・機会）が大きく影響することを示す。自己責任論が社会的連帯を弱め、精神的健康に与える負の影響の研究。
**会話**：「努力は大切。でも、同じ努力が報われやすい環境かそうでないかって、スタートラインが違えばあるよね」。100m走でハンデがある状況の比喩——「ハンデがあることを認めることは、走る必要がないと言ってるわけじゃない」。

### メディア不信・陰謀論
**理解**：既存制度への不信は民主主義的に健全な側面もある。しかし「批判的に読む」と「すべてが嘘」は全く別物。陰謀論は複雑な世界を単純化して理解したいという普遍的な認知的欲求に応えるメカニズムであり（ロバート・ランプレヒトの陰謀論心理研究）、特に不確実性・喪失感・不安が高い時期に機能しやすい。「自分だけが真実を知っている」という感覚は強力な自尊心の源泉にもなる。
**事実**：フィンランドのメディアリテラシー教育——国家的なリテラシー教育によりフェイクニュース耐性が世界最高水準に。プロパガンダ・ディスインフォメーション研究（ナオミ・オレスケスの研究等）。アルゴリズムによる分断——同じ主張が繰り返されることで「多数が信じている」という誤った認識が生じる「エコーチェンバー」メカニズム。
**会話**：「メディアを全部信じるのも危険だけど、全部嘘とするのも同じくらい危険」。複数の異なる情報源を確認する具体的な提案。「この情報、誰が最初に広めたんだろうね」という視点を持つ習慣。

### 環境・気候変動
**理解**：エネルギーコスト・雇用への現実的な不安。「環境問題は遠い話」「自分には関係ない」という心理的距離（バウマイスターの「時間的・空間的距離」研究）。変化によって現在の生活が脅かされるという経済的恐怖。
**事実**：IPCCの科学的コンセンサス——気候科学者の97%以上が人為的気候変動に合意。ナオミ・オレスケス「疑惑の商人」（2010年）——「環境か経済か」という二項対立が化石燃料業界によって意図的に作られた枠組みであることの実証研究。気候変動への対応が新産業・雇用を創出した事例（再生可能エネルギー産業の雇用増）。
...
**会話**：「愛国心と軍国主義は別物」という分岐点を丁寧に。外交的解決の成功例——冷戦終結のプロセス、EU統合。「強くなることと戦争になりにくくすることは、必ずしも同じじゃないかも」。
...
**事実**：「在日特権」とされる多くの内容が法的事実に基づかないことは弁護士会・研究者による検証で示されている。国連・国際人権法はヘイトスピーチを「扇動」として規制し、多くの民主主義国家が法制化している。ヘイトスピーチが標的集団の精神的健康（PTSD・抑うつ）に与える実害の研究（クラーク大学等の研究）。
**会話**：「在日特権って、具体的にどんな特権があると思う？教えてほしいんだけど」と静かに聞いてみる——多くは具体的な答えが出てこない。「表現の自由で守られるべき言論と、特定集団を傷つける言動は、どこが違うと思う？」という問い。

### 民主主義への懐疑・権威主義への傾倒
**理解**：現状政治への失望・無力感は正当な感覚。「強いリーダー」への期待は、複雑な問題を一人の有能な人物に解決してほしいという認知的単純化の欲求と、現状への不満のエネルギーが合流したもの。エーリッヒ・フロムの「自由からの逃走」（1941年）が分析したように、個人の自由と孤立感が権威主義的な服従への誘因となる構造は歴史的に繰り返されている。
**事実**：権威主義の「効率性」は短期的に見えても、長期的には腐敗・人権侵害・経済停滞を招く歴史的事例（多数）。フリーダム・ハウスによる民主主義後退の世界的トレンドの記録。「選挙があれば民主主義」ではない——司法の独立・メディアの自由・市民社会の活力が民主主義の本質であることを示す研究（スティーヴン・レヴィツキー「民主主義の死に方」2018年）。
...

{
  ...
  "understanding": "SECTION 1-① テキスト（400〜550字）",
  "evidence": "SECTION 1-② テキスト（500〜700字）",
  "conversation": "SECTION 2 具体的な伝え方（550〜750字）",
  "question": "「問い1」\\n「問い2」\\n「問い3」",
  "sources": [
    {
